...
class Solution:
    def findOrder(self, numCourses: int, prerequisites):
        ...
        # keep track of the order of courses to take
        ordering = []
        while sources:
            # add the current course as the next one to take
        ...
        # return the order of courses to take if all courses can be taken
