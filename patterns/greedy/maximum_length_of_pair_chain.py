...
Input: [[1,2], [3,4], [2,3]]
Output: 2
Explanation: The longest chain is [1,2] -> [3,4]. The chain [1,2] -> [2,3] is invalid because 2 is not smaller than 2.

Input: [[5,6], [1,2], [8,9], [2,3]]
Output: 3
Explanation: The chain can be [1,2] -> [5,6] -> [8,9] or [2,3] -> [5,6] -> [8, 9].

Input: [[7,8], [5,6], [1,2], [3,5], [4,5], [2,3]]
Output: 3
Explanation: The longest possible chain is formed by chaining [1,2] -> [3,5] -> [7,8].
'''
